...
urlpatterns = [
    ...
    path('board_detail/<int:post_id>',views.board_detail,name='board_detail'), # 지도없는 게시글 읽기
    ...
    path('delete_comment/<int:post_id>/<int:comment_id>', views.delete_comment, name="delete_comment"),
     path('create_bcomment/<int:post_id>', views.create_bcomment, name="create_bcomment"), #댓글생성
    path('delete_bcomment/<int:post_id>/<int:comment_id>', views.delete_bcomment, name="delete_bcomment"),
    path('likes/', views.likes, name="likes"),
    path('board_likes/', views.board_likes, name="board_likes"),
